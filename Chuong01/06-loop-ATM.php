...
<html>
	...
	<body>
        ...
        ?>
        	<div class="header">
        		<img alt="" src="images/atm.jpg">
        		<h1>Mô phỏng máy ATM</h1>
        		<form method="post">
        			<p>Vui lòng nhập số tiền mà quý khách muốn thực hiện giao dịch</p>
            		<input type="text" name="sum" value="<?php echo number_format($sum);?>" placeholder="Hãy nhập số tiền"/>
        	...
        	<div class="noidung">
        		...
        		<p style="float: right;">Tổng tiền: <?php echo number_format($total)?></p>
